...
const Post = ({ post }) => {
	...
	const {mutate:likePost, isPending:isLiking} = useMutation({
		...
		onSuccess : (updatedLikes) => {    // getting as response
			// this is not the best UX (it refetches all the posts)
			// queryClient.invalidateQueries({queryKey : ["posts"]})

			// instead, update the cache directly for that post (does not invalidate query)
